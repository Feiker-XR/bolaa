var WXENV = new (function (ticketUrl) {
    ...
    self.shareData = {
        title: '全新福克斯，行【王者驾临篇】',  // 分享标题
        desc: '三年销冠，王者心胸。全新福特福克斯蓄势待发，邀君共赏。',   // 分享描述
        link: 'http://focus.ser2.ford001.com/',  // 分享链接
        imgUrl: 'http://focus.ser2.ford001.com/img/wxlogo.jpg',  // 分享图标
...
})('http://wxauth.app.bolaa.net/jsticket.ashx?serv_name=mondeocard');