var WXENV = new (function (ticketUrl) {
    ...
    self.shareData = {
        title: '长安福特主品牌广告第二季',  // 分享标题
        desc: '向前走吧!因为福特始终相信，进无止境是我们共同的信仰！',   // 分享描述
        link: 'http://tvc.ser2.ford001.com/',  // 分享链接
        imgUrl: 'http://tvc.ser2.ford001.com/images/share.jpg',  // 分享图标
...
})('http://wxauth.app.bolaa.net/jsticket.ashx?serv_name=kuga2014');