var wxShare = {
    title: '开自己的车，就是踏实',  // 分享标题
    desc: '生活过好，买车要早！迎车改，全国公务员大聚惠。新车新起点，惊喜在春天。',   // 分享描述
    //desc: '开自己的车，就是踏实',
    link: 'http://govcar.ser2.ford001.com/',   // 分享链接
    imgUrl: 'http://govcar.ser2.ford001.com/img/wxlogo.jpg',  // 分享图标
...
var jsapiTicketUrl = 'http://wxauth.app.bolaa.net/jsticket.ashx?serv_name=govcar&url=' + encodeURIComponent(window.location.href);
