<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterXdList.aspx.cs" Inherits="Website.Admin.RegisterXdList" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="bandName" HeaderText="品牌" SortExpression="bandName" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="select a.*,b.Name as bandName from [dbo].[Registers] a,[dbo].[BrandsInfo] b where a.Types=b.Code and ([Type] = @Type) ORDER BY [ID] DESC">
            <SelectParameters>
                <asp:SessionParameter Name="Type" SessionField="cartype" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <%--SELECT * FROM [Registers] WHERE ([Type] = @Type) ORDER BY [ID] DESC--%>
