document.ready = function () {
    ...
    $("#music").bind("touchstart", function (e) {
        if (!music) {
            $("#music").css("background", "url('Content/images/music_off.png')");
            //$("#audio").pause();
            audioEle.pause();
            $("#music").removeClass("mi");
            music = !music;
        } else {
            $("#music").css("background", "url('Content/images/music_on.png')");
            //$("#audio").play();
            audioEle.play();
            $("#music").addClass("mi");
            music = !music;
    ...
    $("#p1").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            //$(".p2_word").hide();
            //$(".p2_light").hide();
            $("#p1").animate({ top: "-1136px" }).hide(100);
    ...
    function p2Main() {
        //$("#p2").css("background","url('Content/images/p2_main.jpg')").fadeIn(3000);
    ...
    $("#p2_1").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            $(".p3_title").hide();
            $("#p2").animate({ top: "-1136px" }, function () {
                $("#p2").hide(100);
                $("#p2_1").hide(100);
            });
            $("#p2_1").animate({ top: "-1136px" });
        ...
        if (startY - endY < -100 && endY != null) {
            ...
            $(".p1_car").hide();
            $(".p1_carer").hide();
            $("#p2").animate({ top: "-1136px" }).hide(100);
            $("#p2_1").animate({ top: "-1136px" }).hide(100);
    ...
    $("#p3").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            $(".p4_title").hide();
            $(".p4_content").hide();
            $("#p3").animate({ top: "-1136px" }).hide(100);
    ...
    $("#p4").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            $(".p5_title").hide();
            $(".p5_content").hide();
            $("#p4").animate({ top: "-1136px" }).hide(100);
    ...
    $(".click").bind("touchstart", function (e) {
        if (touch_count % 2 == 1) {
            $("#p5").css("background", "url('Content/images/p5_bg_close.jpg')");
            touch_count++;
        } else {
            $("#p5").css("background", "url('Content/images/p5_bg.jpg')");
            touch_count++;
        }
    });
    ...
    $("#p5").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            $("#p5").animate({ top: "-1136px" }).hide(100);
    ...
    $("#p6").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            $(".p7_title").hide();
            $(".p7_content").hide();
            $("#p6").animate({ top: "-1136px" }).hide(100);
    ...
    function change(){
    if(!bg){
    $("#p7").css("background","url('Content/images/p7_bg2.jpg')");
    bg=!bg;
    }else{
    $("#p7").css("background","url('Content/images/p7_bg.jpg')");
    bg=!bg;
    }
    }
    */
    ...
    */
    ...
    $("#p7").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            $(".p8_circle4").hide();
            $(".p8_circle5").hide();
            $("#p7").animate({ top: "-1136px" }).hide(100);
    ...
    $("#p8").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            $("#p8").animate({ top: "-1136px" }).hide(100);
    ...
    $("#p9").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            $(".p10_title").hide();
            $(".p10_content").hide();
            $("#p9").animate({ top: "-1136px" }).hide(100);
    ...
    $("#p10").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            $(".p11_title").hide();
            $(".p11_content").hide();
            $("#p10").animate({ top: "-1136px" }).hide(100);
    ...
    $("#p11").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            $("#p11").animate({ top: "-1136px" }).hide(100);
    ...
    $("#p12").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            $(".p13_content").hide();
            $(".p13_car2").hide();
            $("#p12").animate({ top: "-1136px" }).hide(100);
    ...
    $("#p13").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            $(".p14_title").hide();
            $(".p14_content").hide();
            $("#p13").animate({top:"-1136px"}).hide(100);
    ...
    $(".p15_title").hide();
    $(".p15_content").hide();
    $("#p14").animate({top:"-1136px"}).hide(100);
    $("#p15").show().animate({top:"0px"});
    $(".p15_title").fadeIn(1500);
    $(".p15_content").fadeIn(2000).show();
    startY=null;
    ...
    */
    ...
    $("#p15").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            $("#p15").animate({ top: "-1136px" }).hide(100);
    ...
    $("#p16").bind("touchend", function (e) {
        if (startY - endY < -100 && endY != null) {
            $(".p15_title").hide();
            $(".p15_content").hide();
            $("#p16").animate({ top: "1136px" }).hide(100);
            $("#p15").show().animate({ top: "0px" });
            $(".p15_title").fadeIn(1500);
            $(".p15_content").fadeIn(2000).show();
            startY = null;
    ...
    //loading
    $(".loading").show();
    var imgsstr = ["Content/images/click.png", "Content/images/p1_bg.jpg", "Content/images/p1_car.png", "Content/images/p1_car.gif", "Content/images/p1_light1.png", "Content/images/p1_light2.png", "Content/images/p1_word1.png", "Content/images/p1_word2.png", "Content/images/p1_word3.png", "Content/images/p1_word4.png", "Content/images/p2_light.png", "Content/images/p2_main.jpg", "Content/images/p2_word.png", "Content/images/p3_bg.jpg", "Content/images/p3_title.png", "Content/images/p3_word.png", "Content/images/p4_bg.jpg", "Content/images/p4_title.png", "Content/images/p4_content.png",
	"Content/images/p5_bg.jpg", "Content/images/p5_bg_close.jpg", "Content/images/p5_title.png", "Content/images/p5_content.png", "Content/images/p6_bg.jpg", "Content/images/p6_title.png", "Content/images/p6_content.png", "Content/images/p7_bg.jpg", "Content/images/p7_title.png", "Content/images/p7_content.png", "Content/images/p7_monitor.png", "Content/images/p8_bg.jpg", "Content/images/p8_title.png", "Content/images/p8_content.png", "Content/images/p8_circle1.png", "Content/images/p8_circle2.png", "Content/images/p8_circle3.png", "Content/images/p8_circle4.png", "Content/images/p8_circle5.png",
	"Content/images/p9_bg.jpg", "Content/images/p9_title.png", "Content/images/p9_content.png", "Content/images/p10_black_car.png", "Content/images/p10_white_car.png", "Content/images/p10_content.png", "Content/images/p10_bg.jpg", "Content/images/p10_title.png", "Content/images/p11_bg.jpg", "Content/images/p11_title.png", "Content/images/p11_content.png", "Content/images/p12_bg.jpg", "Content/images/p12_title.png", "Content/images/p12_content.png", "Content/images/p12_car.png", "Content/images/p12_wheel.png", "Content/images/p13_bg.jpg", "Content/images/p13_car.png", "Content/images/p13_content.png", "Content/images/p13_car2.png", "Content/images/p13_bg.jpg", "Content/images/p13_content.png", "Content/images/p14_bg.jpg", "Content/images/p14_title.png", "Content/images/p14_content.png", "Content/images/p16_bg.jpg"];
    var imgs = new Array();
    var img;
